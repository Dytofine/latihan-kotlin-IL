...
////    println("The marks and time limit fot an easy question is ${easyQuestion.mark} mark and ${easyQuestion.time} min")
////}
//
//
//sealed class Question{
...
//            "Easy question Mark: ${question.mark} Time:${question.time} min and Hint: ${question.hint}"
//        is Question.Difficult->
//            "Easy question Mark: ${question.mark} Time:${question.time} min Hint: ${question.hint} and Solution: ${question.solution}"
//
//    }
//}
//
//fun main (){
//    val easyQuestion = Question.Easy(1,1)
//    val difficultQuestion = Question.Difficult(5,6,"Susbtitution method", "x=5, y=3")
